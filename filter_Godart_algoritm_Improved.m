function data_output = filter_Godart_algoritm_Improved(Data_input,q,p,mu)
...
%filter_to_work here:
data_output(i-data_size+1:1:i,1) = filter_Godart_algoritm_demo(Data_input_temperaly,q,p,mu);
