function data_output = filter_Kalman_Improved(Data_input,Desired_signal,Lamda,Step)
...
%filter_to_work here:
data_output(i-data_size+1:1:i,1) = filter_Kalman_demo(Data_input_temperaly,Desired_signal_temperaly,Lamda,Step);
