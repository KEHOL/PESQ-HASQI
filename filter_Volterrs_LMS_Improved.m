function data_output = filter_Volterrs_LMS_Improved(Data_input,Desired_signal,mu,step,mu_step)
...
for i = data_size:data_size:numel(Data_input)+floor(data_size/2)
...
%filter_to_work here:
data_output(i-data_size+1:1:i,1) = filter_Volterrs_LMS_demo(Data_input_temperaly,Desired_signal_temperaly,mu,step,mu_step);
