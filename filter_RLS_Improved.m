function data_output = filter_RLS_Improved(Data_input,Desired_signal,Lamda)
...
%filter_to_work here:
data_output(i-data_size+1:1:i,1) = filter_RLS_demo(Data_input_temperaly,Desired_signal_temperaly,Lamda);
